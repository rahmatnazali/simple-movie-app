...
let generate_result_html = function (response) {
    response.forEach(e => {
        console.log(e);
        console.log(e.name);
        console.log(e.slug);
...
let ajax_call = function (endpoint, request_parameters) {
    ...
    $.getJSON(endpoint, request_parameters)
        .done(response => {
            ...
            autocomplete(document.getElementById("user-input"), response);
